  ...
  <body id="contentContainer" class="container bg-dark" >
    ...
    <div class="row">
      <div class="btn-group">
        ...
        <a href="opsviewer_i.php" class="btn btn-secondary active" aria-current="page">Health Issue Staff <span class="badge bg-dark rounded-pill"><?php echo $reqcounti; ?></span></a>
      ...
      <table class="table table-striped-columns shadow rounded" width="98%" style="border-collapse: collapse; font-size: 13px">
        ...
        <tbody>
          <?php
            ...
            WHERE health_iscomplete='no' AND health_type='other'");
            $count = 0;
