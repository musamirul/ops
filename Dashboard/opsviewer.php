...
<html lang="en">
  ...
  <body id="contentContainer" class="container bg-dark" >
    ...
    <div class="row">
      <div class="btn-group">
        <?php
          $query_countreq = mysqli_query($con,"SELECT count(*) FROM user WHERE user_type = '2'");
        ...
        <a href="#" class="btn btn-secondary">Management Parking <span class="badge bg-dark rounded-pill">2</span></a>
        <a href="#" class="btn btn-secondary">Consultant Parking <span class="badge bg-dark rounded-pill">2</span></a>
        <a href="#" class="btn btn-secondary">Illness Parking <span class="badge bg-dark rounded-pill">2</span></a>
      </div>
    </div>
