        ...
        <div class="row pt-2 ps-5 pe-5 ms-5 me-5">
            ...
            <div style="background-color: rgb(219, 250, 215); " class="col ms-5">
                ...
                <div class="row ">
						...
						?>      
							<div style="width:95%" class="shadow-lg bg-light rounded mb-3 pt-2 ms-3">
                                <div class="row justify-content-center">
                                    <span style="font-size: 25px; font-weight: 600;">
                                        <?php echo $user_fname; ?>
                                        
                                        <button type="button" class="btn-sm <?php if($reqcount==0){echo 'btn-warning';}else{echo 'btn-info';} ?> position-relative rounded-circle"  data-bs-toggle="modal" data-bs-target="#viewCar<?php echo $user_id ?>">
                                ...
                                <div class="row justify-content-center">
                                    <span style="font-size: 15px; font-weight: 400;">
                                        <?php echo $services_name; ?> (<?php echo $user_position; ?>)
                                        <?php
                                            if($searchResult['user_isactive']=='yes'){
                                                echo '<i class="bi bi-check-square-fill" style="color:green"> active</i>';
                                            }else{
                                                echo '<i class="bi bi-x-square-fill" style="color:red"> inactive</i>';
                                            }
                                        ?>
                                    </span>
                                </div>
                                ...
                                <div class="p-2">
                                    <button type="submit"  class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addCar<?php echo $user_id ?>">Add Car</button>
                                    <button type="submit"  class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?php echo $user_id ?>">Edit Profile</button>
                                    <button type="submit" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete<?php echo $user_id ?>">Delete</button>
                                </div>
							</div>
						<?php            
								}
